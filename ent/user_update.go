...
func (_u *UserUpdate) SetAffiliation(v string) *UserUpdate {
	_u.mutation.SetAffiliation(v)
	return _u
}

// SetNillableAffiliation sets the "affiliation" field if the given value is not nil.
func (_u *UserUpdate) SetNillableAffiliation(v *string) *UserUpdate {
	if v != nil {
		_u.SetAffiliation(*v)
	}
	return _u
...
func (_u *UserUpdate) ClearAffiliation() *UserUpdate {
	_u.mutation.ClearAffiliation()
	return _u
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Affiliation(); ok {
		_spec.SetField(user.FieldAffiliation, field.TypeString, value)
	}
	if _u.mutation.AffiliationCleared() {
		_spec.ClearField(user.FieldAffiliation, field.TypeString)
	}
...
// SetAffiliation sets the "affiliation" field.
func (_u *UserUpdateOne) SetAffiliation(v string) *UserUpdateOne {
	_u.mutation.SetAffiliation(v)
	return _u
}

// SetNillableAffiliation sets the "affiliation" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableAffiliation(v *string) *UserUpdateOne {
	if v != nil {
		_u.SetAffiliation(*v)
	}
	return _u
...
// ClearAffiliation clears the value of the "affiliation" field.
func (_u *UserUpdateOne) ClearAffiliation() *UserUpdateOne {
	_u.mutation.ClearAffiliation()
	return _u
}
