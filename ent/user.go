...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldPassword, user.FieldNickname, user.FieldAffiliation, user.FieldRole:
...
func (_m *User) String() string {
	...
	builder.WriteString(_m.Affiliation)
	builder.WriteString(", ")
