...
func (_c *UserCreate) SetAffiliation(v string) *UserCreate {
	_c.mutation.SetAffiliation(v)
	return _c
}

// SetNillableAffiliation sets the "affiliation" field if the given value is not nil.
func (_c *UserCreate) SetNillableAffiliation(v *string) *UserCreate {
	if v != nil {
		_c.SetAffiliation(*v)
	}
	return _c
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Affiliation(); ok {
